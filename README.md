...
Reverse-engineered and tested on real hardware. Built with AI assistance
(Claude) — the Bluetooth protocol analysis, byte signatures, and the
`tshark`/USBPcap workaround were worked out by capturing and decoding live
traffic from actual Nothing Headphones (1).
